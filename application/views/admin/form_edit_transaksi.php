					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="text" name="tgl_sewa" class="form-control picker" onclick="disable()" value="<?= indo_date($ts->tanggal_sewa)?>" required>
							</div>
							<div class="form-group">
								<label>Tanggal Kembali</label>
								<input type="text" name="tgl_kembali" class="form-control picker" onclick="disable()" value="<?= indo_date($ts->tanggal_kembali)?>" required>
							</div>
						</div>
